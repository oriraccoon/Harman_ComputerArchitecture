...
module OV7670_VGA_Display (
    ...
    Gaussian_Blur U_GAUSS_grayscale (
        .*,
    ...
    Croma_Key_Filter U_CROMA_KEY (
        .CROMA_KEY(CROMA_KEY),
        .data(i_data),
        .CROMA_RGB444_data(CROMA_RGB444_data)
    );

    Filter_mux U_Second_mux (
        .clk(clk),
        .reset(reset),
        .sel(rgb_sw[2]),
        .btn(btn),
        .x0(FIRST_RGB444_data),
        .x1(MOPOL_RGB444_data),
        .x2(GAUSS_GRAY444_data),
        .x3(GAUSS_GRAY444_data),
        .x4(CROMA_RGB444_data),
