module Instruction_Memory (
    ...
    initial begin
        ...
        rom[29] = 32'b0000000_00011_00010_000_01000_1100011; // BEQ  x2, x3, 8    ; 2 == 2 → 참 → PC += 8
        rom[30] = 32'b0000000_00011_00100_001_01000_1100011; // BNE  x4, x3, 8    ; 3 != 2 → 참 → PC += 8
        rom[31] = 32'b0000000_00101_00110_100_01000_1100011; // BLT  x5, x6, 8    ; -4 < -3 → 참 → PC += 8 
        rom[32] = 32'b0000000_00110_00101_101_01000_1100011; // BGE  x6, x5, 8    ; -3 ≥ -4 → 참 → PC += 8
        rom[33] = 32'b0000000_00100_00011_110_01100_1100011; // BLTU x3, x4, 8    ; 2 < 3 → 참 → PC += 12
        rom[34] = 32'b0000000_00100_00011_111_01000_1100011; // BGEU x4, x3, 8    ; 2 ≥ 3 → 거짓 → PC += 4
