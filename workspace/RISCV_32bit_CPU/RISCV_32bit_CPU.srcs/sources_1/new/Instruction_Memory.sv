module Instruction_Memory (
    ...
    initial begin
        ...
        rom[5] = 32'b0000000_00101_00100_001_01000_1100011; // bne PC, 8, x4, x5;       
        ...
        */
        rom[8] = 32'b00000000000000000001_01011_0110111; // LU_TYPE x11, 48, x0;    
        //rom[9] = 32'b10000000000000000000_01100_0010111; // AU_TYPE x12, 48, x0;    
        rom[10] = 32'b00000000100000000000_01101_1101111; // J_TYPE x13, 48, x0;    
        rom[12] = 32'b000000000100_00010_000_01110_1100111; // JL_TYPE x14, 48, x0;    
    end
