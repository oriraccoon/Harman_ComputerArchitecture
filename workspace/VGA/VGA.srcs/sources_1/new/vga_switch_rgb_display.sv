...
module test_pattern_display (
    ...
    always_comb begin
        case (control_sw)
            ...
            4'b0100: begin
                if (
                    // 왼쪽 윗 원 (240, 170), 반지름 40
                    ( (x_coor - 240)*(x_coor - 240) + (y_coor - 170)*(y_coor - 170) <= 1600 ) ||

                    // 오른쪽 윗 원 (400, 170)
                    ( (x_coor - 400)*(x_coor - 400) + (y_coor - 170)*(y_coor - 170) <= 1600 ) ||

                    // 아래 삼각형 (중앙 하트 아래쪽 꼬리 부분)
                    ( (y_coor >= 170) && (y_coor <= 384) &&
                    (x_coor >= (240 + ((y_coor - 170)*5)/3)) &&
                    (x_coor <= (400 - ((y_coor - 170)*5)/3))
                    )
                ) begin
                    vgaRed   = 4'd15;
                    vgaGreen = 4'd0;
            ...
            4'b0001: begin
                ...
                else if (~((x_coor < 320) || (y_coor == x_coor - 480)) && ~((x_coor >= 320) || (y_coor == x_coor - 100))) begin
                    if (display_en) begin
                        vgaRed = red3;
                        vgaGreen = green3;
                        vgaBlue = blue3;
                ...
                else if ((x_coor >= 320) || (y_coor == x_coor - 100)) begin
                    if (display_en) begin
                        vgaRed = red2;
                        vgaGreen = green2;
                        vgaBlue = blue2;
            ...
            4'b0010: begin
                if ((x_coor >= 320) || (y_coor == x_coor - 100)) begin
                    if (display_en) begin
                        red2   = r_sw;
                        green2 = g_sw;
                        blue2  = b_sw;
            ...
            4'b0011: begin
                if (~((x_coor < 320) || (y_coor == x_coor - 480)) && ~((x_coor >= 320) || (y_coor == x_coor - 100))) begin
                    if (display_en) begin
                        red3   = r_sw;
                        green3 = g_sw;
                        blue3  = b_sw;
